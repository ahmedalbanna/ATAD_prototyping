...
import { Home, Package, LayoutDashboard, ClipboardList, User } from "lucide-react";
          ...
          {navItems.map(item => {
            ...
            return (
              <Link key={item.to} to={item.to}
                className={`flex flex-col items-center justify-center gap-0.5 py-1.5 px-3 rounded-2xl transition-all duration-200 ${isActive
