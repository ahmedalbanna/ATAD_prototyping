...
import { Package, Camera, Check, ArrowLeft, Plus } from "lucide-react";

const steps = [
  {
    title: "أهلاً بك كمؤجر",
    desc: "سنساعدك في خطوات بسيطة لبدء تأجير أصولك على منصة عتاد",
    icon: Package,
  },
  {
    title: "أضف أصولك",
    desc: "يمكنك إضافة معداتك وأجهزتك للتأجير. صورها وحدد سعر التأجير اليومي",
    icon: Camera,
  },
  {
    title: "استقبل الطلبات",
    desc: "عندما يطلب مستأجر أحد أصولك، ستتلقى إشعاراً للموافقة أو الرفض",
    icon: Check,
  },
  {
    title: "ابدأ الآن",
    desc: "أنت جاهز! ابدأ بإضافة أول أصل لك الآن",
    icon: Plus,
  },
];

export default function OnboardingLessor() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col p-6">
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full text-center">
        <div className={`w-24 h-24 bg-primary/10 rounded-3xl flex items-center justify-center mx-auto mb-8 transition-all duration-500 animate-scale-in`}>
